...
public class DataHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE pesanan (kd_pesanan integer NOT NULL PRIMARY KEY, tanggal date NOT NULL, jam time NOT NULL, nomor_meja int NOT NULL, nama_menu text NOT NULL, harga integer NOT NULL, qty integer NOT NULL)");
        db.execSQL("INSERT INTO pesanan (kd_pesanan, tanggal, jam, nomor_meja, nama_menu, harga, qty) VALUES (2001, '2020-12-04', '10:59', 2 , 'Kopi Hitam', 10000, 2)");
    }
